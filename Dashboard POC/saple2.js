...
/**
 * Loads the dashboard configuration from the server and renders the
 * dashboard UI.
 *
 * It fetches the dashboard configuration from the server, removes all
 * existing widgets from the grid, creates new widgets based on the
 * configuration, and renders them in the grid. If a widget has a chart
 * configuration, it is also rendered.
 */
...
function saveSettings() {
  ...
  //   activeWidget.querySelector(".widget-title").innerText = title;
  //   activeWidget.dataset.type = chartType;

  //   // 🔥 UPDATE chart config
  //   activeWidget.dataset.chartConfig = JSON.stringify({
  //     type: chartType,
  //     x: "date",
  //     y: "amount"
  //   });
...
//   exitWidgetSettings();
//   showToast("All set! Your new widget has been added successfully!");
// }
...
//   const type = widget.dataset.type || "line";
...
//       datasets: [{
//         label: "Orders",
//         data: [2, 1.5, 2.5, 2.3, 3, 3.2, 2.7, 2.1, 1.9, 2.2, 2.6, 3],
//         borderColor: "#3b82f6",
